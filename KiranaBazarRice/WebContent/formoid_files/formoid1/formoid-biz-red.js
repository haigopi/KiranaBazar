...
! function(c) {
    var a = function(e, d) {
        ...
        this.picker = c(b.template).appendTo(d.appendTo || this.element.parent() || "body").on({
...
jQuery(".formoid-biz-red").find('input[type=date]').each(function() {
    var date = $(this);
...
jQuery(function() {
    // Custom Selects
    jQuery(".element-select select").selectpicker({
        style: 'btn-huge btn-primary',
        menuStyle: 'dropdown-inverse'
    });
    jQuery(".element-address select").selectpicker({
        style: 'btn-huge btn-primary',
        menuStyle: 'dropdown-inverse'
    });
    jQuery(".element-multiple select[multiple='multiple']").selectpicker({
        style: 'btn-huge btn-primary',
        menuStyle: 'dropdown-inverse'
    });
